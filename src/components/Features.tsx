...
function BentoTilt({
  ...
  const handleMouseMove = (e: React.MouseEvent) => {
    ...
    const titlY = (relativeY - 0.5) * -5;

    const newTransform = `perspective(700px) rotateX(${tiltX}deg) rotateY(${titlY}deg) scale3d(0.98, 0.98, 0.98)`;
      ...
      <div className="container mx-auto px-3 md:px-10">
        <div className="px-5 py-32">
          ...
          <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
            ...
            vibrant layer array of products converge into a interconnected
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
          ...
          <BentoTilt className="bento-tilt_2">
            <div className="flex size-full flex-col justify-between bg-violet-300 p-5">
              <h1 className="bento-title special-font max-w-64 text-black/80">
                M<b>o</b>re commin<b>g</b> soo<b>n</b>!
              </h1>
